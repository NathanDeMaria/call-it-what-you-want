...
from .candidates import NameCandidate, TeamActivity
from .data import NCAA, default_teams, local_csv
from .local import local_path
...
from .types import ESPN, TeamName
...
def test_recording_stages_rows_and_takes_effect() -> None:
    ...
    # Written where the package stages things.
